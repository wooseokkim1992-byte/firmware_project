 ...
 */
static vibration_state_t vibration_state_determine(
...
)
{
        ...
        == VIBRATION_STATE_NORMAL)
    {
         ...
         */
        if (vibration_value
            >= state_config.warning_threshold)
        {
...
bool vibration_state_update(float vibration_value)
{
    ...
    * 도달하지 않았다.
    */
    if (state_data.candidate_count
        < state_config.persistence_count)
    {
        return false;
    }
